...
export function AppOverlays({ runDetail, artifact, lightbox, activePath, account, models, power, onCloseRun, onCloseArtifact, onCloseLightbox, onOpenArtifact }) {
  return (
    <>
      {runDetail && (
        <RunDetailOverlay
...
function RunDetailOverlay({ detail, power, activePath, account, models, onClose, onOpenArtifact }) {
...
function ArtifactOverlay({ artifact, activePath, account, models, onClose }) {
  return (
    <div className="viewer-modal" role="dialog" aria-modal="true">
      <div className="viewer-card wide">
        <button type="button" className="viewer-close" onClick={onClose}>Close</button>
