...
SRC = "/tmp/deck/ariadne-deck.pptx"
DST = "/tmp/deck/ariadne-deck.pptx"  # overwrite in place
WORK = "/tmp/deck/_unz"
CASCADE_SLIDES = {2, 6, 11}  # flow slides — elements appear one by one
...
shutil.move(tmp, DST)
shutil.rmtree(WORK)
print(f"injected: fade transition on 16 slides; cascade entrance on {n_anim} flow slides")
