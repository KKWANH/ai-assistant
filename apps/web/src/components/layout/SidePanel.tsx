...
export function SidePanel() {
  ...
  return (
    <aside
      className="hidden lg:flex flex-col w-80 shrink-0 border-l border-inspector-border/60 bg-inspector/38 glass glass-control backdrop-blur-xl backdrop-saturate-[1.8] overflow-hidden"
