...
export function Inspector() {
  ...
  return (
    <aside
      className="hidden lg:block w-64 shrink-0 border-l border-inspector-border/60 bg-inspector/38 glass glass-control backdrop-blur-xl backdrop-saturate-[1.8] overflow-y-auto"
