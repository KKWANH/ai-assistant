...
export function ChatComposer({
  ...
  return (
    <div className="flex flex-col gap-2" data-tour="composer">
      ...
      <div
        ref={composerRef}
        className={`glass glass-control backdrop-blur-2xl backdrop-saturate-[1.8] relative flex flex-col gap-2 rounded-xl border bg-surface-2/42 px-3 pt-3 pb-2 focus-within:border-border-strong transition-colors ${
