  ...
  return (
    ...
    >
      <form onSubmit={(e) => void handleSubmit(e)} className="flex flex-col gap-4">
        ...
        {/* Visibility selector — public means other authenticated accounts
            can read this workspace's content. Writes (edit, scan, delete)
            stay restricted to the owner. See routes/workspaceGuard.ts. */}
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-medium text-muted-foreground">
