...
function SearchBox() {
  ...
  return (
    <div ref={boxRef} className="relative">
      ...
      {open && q && (
        <div className="absolute left-0 right-0 top-full z-20 mt-1.5 overflow-hidden rounded-lg border border-border bg-card/90 backdrop-blur-xl backdrop-saturate-[1.8] ring-1 ring-inset ring-white/[0.08] shadow-lg">
          {hits.length === 0 ? (
