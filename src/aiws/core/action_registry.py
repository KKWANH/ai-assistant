...
def investment_rebalancer_app_definition() -> dict[str, Any]:
    return contracts.workflow_app_definition(
        ...
        output_schema=[
            ...
            contracts.output_artifact_spec("artifacts/monthly-performance.csv", "csv", "tableViewer", "Monthly asset and return table."),
            contracts.output_artifact_spec("artifacts/portfolio-growth-chart.json", "chart", "chartViewer", "Monthly total asset chart."),
        ],
